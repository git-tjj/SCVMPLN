...
VMPLN_evaluator<-function(penalize_diagonal = FALSE,
  ...
  repres_VMPLN<-foreach (
    ...
    .packages = c('MASS','glasso',
                  ...
                  "cluster","pryr","philentropy","umap","Seurat","igraph","Rcpp","SCVMPLN","Matrix","stats","fpc","GMPR")
  )%dopar%{
    ## load data-------------
    ...
    res_init<-VMPLN_main(VMPLN_list = res_init,lambda_use = 1e-6,
    ...
    ##
    ######################################
    lambda_max_res <- exact_lambdamax(VMPLN_list = res_init,
    ...
    for (l in 1:length(lambda_vec)) {
      ...
      res_VMPLN_NN<-VMPLN_main(VMPLN_list = res_init0,lambda_use = lambda_vec[l],
      ...
      BIC_mat_shrink[,l]<-res_VMPLN_NN$VMPLN_bic_VMICL
      BIC_mat_shrink1[,l]<-res_VMPLN_NN$VMPLN_bic_VICL
      ##
      
      for(g in 1:group_num){
        Theta_mat_array_hat_all[,,g,l]<-as.matrix(res_VMPLN_NN$Theta_mat_list[[g]])
      }
      ##
      for(g in 1:group_num){
      ...
      ##
      U_mat_array[l,,]<-res_VMPLN_NN$U_mat
      ## Calculate the soft clustering strength
      U_mat_max<-matrix(0,nrow = nrow(res_VMPLN_NN$U_mat),ncol = ncol(res_VMPLN_NN$U_mat))
      for(i in 1:nrow(U_mat_max)){
        U_mat_max[i,which.max(res_VMPLN_NN$U_mat[i,])]<-1
      }
      soft_cs<-mean(as.vector(abs(res_VMPLN_NN$U_mat - U_mat_max)))
      soft_cs_vec<-c(soft_cs_vec,soft_cs)
      ##purity
      locator_cur<-apply(res_VMPLN_NN$U_mat,MARGIN = 1,which.max)
      ...
      ##
      cluster_acc<-c(cluster_acc,adjustedRandIndex(apply(res_VMPLN_NN$U_mat,MARGIN = 1,which.max),cluster_true))
    ...
    ##save
    save(Theta_array_hat_VICL,file = paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_VICL_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
    ...
    save(Theta_array_hat_VMICL,file = paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_VMICL_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                                                 "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
    save(Theta_array_hat_density,file = paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_density_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                                                 "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
    save(Theta_array_hat_density2,file = paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_density2_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                                                    "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
    save(cluster_predict_true_vec,file = paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/cluster_predict_true_vec_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                                            "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
    ##
  ...
  if(if_stability_eval == TRUE){
    ...
    for(rep in 1:reptime){
      edge_true_num<-repres_VMPLN[rep,(ncol(repres_VMPLN)-2):ncol(repres_VMPLN)]
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_VMICL_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/cluster_predict_true_vec_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      ##
    ...
    for(rep in 1:reptime){
      edge_true_num<-repres_VMPLN[rep,(ncol(repres_VMPLN)-2):ncol(repres_VMPLN)]
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_VICL_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/cluster_predict_true_vec_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      ##
    ...
    for(rep in 1:reptime){
      edge_true_num<-repres_VMPLN[rep,(ncol(repres_VMPLN)-2):ncol(repres_VMPLN)]
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_density_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/cluster_predict_true_vec_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      ##
    ...
    for(rep in 1:reptime){
      edge_true_num<-repres_VMPLN[rep,(ncol(repres_VMPLN)-2):ncol(repres_VMPLN)]
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/Theta_array_hat_density2_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      load(paste(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/result/result_all/VMPLN/cluster_predict_true_vec_1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
                       "_nettype",network_type[net],"_ARI_",ARI_i,"_library_size_est_",library_size_est,"_penalize_diagonal_",penalize_diagonal,"_rep",rep,".Rdata",sep = "")))
      ##
  ...
  return(list(repres_VMPLN = repres_VMPLN,
...
VPLN_evaluator<-function(penalize_diagonal = FALSE,self_lambda = TRUE,if_stability_eval = FALSE){
  ...
  repres_VPLN<-foreach (
    ...
    .packages = c('MASS','glasso',
                  'mclust','mltools','data.table','PLNmodels','dplyr',
                  "cluster","pryr","philentropy","umap","Seurat","igraph","Rcpp","SCVMPLN","Matrix","stats","GMPR")
  )%dopar%{
    ## load data-------------
    load(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/data/data1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
               "_nettype",network_type[net],"_ARI:",ARI_i,"_clustermethod",clustermethod_i,"_rep",rep,".Rdata",sep = ""))
...
ppcor_evaluator<-function(penalize_diagonal = FALSE,method = "pearson",if_stability_eval = FALSE){
  ...
  repres_ppcor<-foreach (
    ...
    .packages = c('MASS','glasso',
                  'mclust','mltools','data.table','PLNmodels','dplyr',
                  "cluster","pryr","philentropy","umap","Seurat","igraph","Rcpp","SCVMPLN","Matrix","stats","GMPR","ppcor")
  )%dopar%{
    ## load data-------------
    load(paste("/home/ruibinxi_pkuhpc/lustre1/tjj/pro2/simulation_1.27.1/data/data1015_sam",sample_size_mat[p_i,s_i],"_dim",dim_use_vec[p_i],"_drop",m_i,
               "_nettype",network_type[net],"_ARI:",ARI_i,"_clustermethod",clustermethod_i,"_rep",rep,".Rdata",sep = ""))
...
for(rep in 1:reptime){
  ...
  while (con_use & iter0<100) {
    ...
    suppressWarnings(res_init<-VMPLN_init(expression_profile = as(t(obs_mat),"sparseMatrix"),
...
#####################################################################
repres_all<-list()
##5.3.1 VMPLN (penalized diagonal)
print("VMPLN start (penalized diagonal).")
repres_VMPLN_pd<-VMPLN_evaluator(penalize_diagonal = TRUE,if_stability_eval = FALSE)
repres_all[[1]]<-repres_VMPLN_pd

##5.3.2 VMPLN (non penalized diagonal)
print("VMPLN start (not penalized diagonal).")
repres_VMPLN_nonpd<-VMPLN_evaluator(penalize_diagonal = FALSE,if_stability_eval = FALSE)
repres_all[[2]]<-repres_VMPLN_nonpd
