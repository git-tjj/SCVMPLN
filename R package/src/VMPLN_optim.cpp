...
// [[Rcpp::export]]
Rcpp::List VMPLN_optim(Eigen::VectorXi celltypes_label_input,
  ...
  //
  Eigen::VectorXd VMPLN_bic_VMICL;
  // Eigen::VectorXd VMPLN_loglikelihood_VMICL;
  Eigen::VectorXd VMPLN_bic_VICL;
  // Eigen::VectorXd VMPLN_loglikelihood_VICL;
  VMPLN_bic_VMICL.setZero(celltypes_num);
  // VMPLN_loglikelihood_VMICL.setZero(celltypes_num);
  VMPLN_bic_VICL.setZero(celltypes_num);
  // VMPLN_loglikelihood_VICL.setZero(celltypes_num);
  ...
  //
  VMPLN_bic_VMICL = BIC_fun(Theta_mat_list,
                            U_mat,
                            m_mat_list,
                            s_sq_mat_list,
                            obs_mat,
  ...
  VMPLN_bic_VICL = BIC_fun(Theta_mat_list,
                           U_max,
                           m_mat_list,
                           s_sq_mat_list,
                           obs_mat,
  ...
  if(penalize_diagonal == false){
    return Rcpp::List::create(Named("celltypes_label") = celltypes_label_trans,
                              ...
                              Named("VMPLN_bic_VMICL") = VMPLN_bic_VMICL,
                              Named("VMPLN_bic_VICL") = VMPLN_bic_VICL);
  }else{
    return Rcpp::List::create(Named("celltypes_label") = celltypes_label_trans,
                              Named("U_mat") = U_mat_trans,
                              Named("mu_mat") = mu_mat_trans,
