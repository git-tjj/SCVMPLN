...
RcppExport SEXP _SCVMPLN_log_det(SEXP matrix_listSEXP, SEXP celltypes_numSEXP, SEXP core_numSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SCVMPLN_log_det_block(SEXP matrix_listSEXP, SEXP celltypes_numSEXP, SEXP p_GRNSEXP, SEXP core_numSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type matrix_list(matrix_listSEXP);
...
RcppExport SEXP _SCVMPLN_log_det_GRN(SEXP matrix_listSEXP, SEXP celltypes_numSEXP, SEXP p_GRNSEXP, SEXP core_numSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type matrix_list(matrix_listSEXP);
...
RcppExport SEXP _SCVMPLN_ADMM1(SEXP Theta_mat_sparseSEXP, SEXP s_sq_mat_allSEXP, SEXP obs_matSEXP, SEXP mu_vec_allSEXP, SEXP m_mat_start_allSEXP, SEXP S_depthSEXP, SEXP var_index_mSEXP, SEXP GRN_numSEXP, SEXP core_numSEXP, SEXP ADMM_maxiterSEXP, SEXP thSEXP, SEXP rho_inputSEXP, SEXP is_rho_inputSEXP, SEXP is_rho_constant_nonGRNSEXP, SEXP is_update_nonGRNpartSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SCVMPLN_Newtown(SEXP diag_Theta_allSEXP, SEXP s_sq_mat_start_allSEXP, SEXP m_mat_allSEXP, SEXP S_depth_useSEXP, SEXP var_index_sSEXP, SEXP p_GRNSEXP, SEXP core_numSEXP, SEXP newtown_maxiterSEXP, SEXP thSEXP, SEXP low_boundSEXP, SEXP is_update_nonGRNpartSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _SCVMPLN_Theta_fun(SEXP U_matSEXP, SEXP Theta_mat_listSEXP, SEXP m_mat_listSEXP, SEXP s_sq_mat_listSEXP, SEXP p_GRNSEXP, SEXP lambda_useSEXP, SEXP zero_GRNSEXP, SEXP stop_thresholdSEXP, SEXP var_index_ThetaSEXP, SEXP penalize_diagonalSEXP, SEXP zero_GRN_useSEXP, SEXP core_numSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(VMPLN_optim(celltypes_label_input, U_mat_input, mu_mat_input, m_mat_list_input, s_sq_mat_list_input, pi_vec_input, obs_mat_input, S_depth_input, gene_GRN_index_use_input, Theta_mat_list_input, zero_GRN_input, if_zero, log_det_vec_input, lambda_use, penalize_diagonal, maxit_nonGRN, MS_update_threshold, maxit, minit, ELBO_threshold, verbose, ADMM_max_step, ADMM_threshold, Newton_max_step, Newton_threshold, Theta_threshold, core_num, U_fix));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_SCVMPLN_log_det", (DL_FUNC) &_SCVMPLN_log_det, 3},
    {"_SCVMPLN_log_det_block", (DL_FUNC) &_SCVMPLN_log_det_block, 4},
    {"_SCVMPLN_log_det_GRN", (DL_FUNC) &_SCVMPLN_log_det_GRN, 4},
    {"_SCVMPLN_ADMM1", (DL_FUNC) &_SCVMPLN_ADMM1, 15},
    {"_SCVMPLN_Newtown", (DL_FUNC) &_SCVMPLN_Newtown, 11},
    {"_SCVMPLN_Theta_fun", (DL_FUNC) &_SCVMPLN_Theta_fun, 12},
    {"_SCVMPLN_VMPLN_optim", (DL_FUNC) &_SCVMPLN_VMPLN_optim, 28},
    {NULL, NULL, 0}
};

RcppExport void R_init_SCVMPLN(DllInfo *dll) {
